...
#define clSafeCall( err ) LiFFT::libraries::clFFT::__clSafeCall( err, __FILE__, __LINE__ )
#define clFFTSafeCall( err ) LiFFT::libraries::clFFT::__clSafeCall( err, __FILE__, __LINE__ )
#define clCheckError(err) LiFFT::libraries::clFFT::__clSafeCall( err, __FILE__, __LINE__ )
...
inline void printClDevice(cl_device_id dev_id)
{
  char* value;
  size_t valueSize;
