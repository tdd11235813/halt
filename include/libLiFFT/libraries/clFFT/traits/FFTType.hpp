...
namespace traits{
  ...
  /* @todo what about CLFFT_SINGLE|DOUBLE_FAST */
  ...
  /* @todo what about planar or hermitian layout ([compressed] SoA)
   * @see http://clmathlibraries.github.io/clFFT/index.html (Supported Modes)
   */
